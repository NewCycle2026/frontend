    ...
    <MainLayout>
      ...
      <section className="relative h-[20vh] bg-emerald-700 text-white flex items-center justify-center overflow-hidden">
        ...
        <div className="relative text-center px-4 max-w-lg mx-auto animate-fadeIn">
          <h1 className="text-3xl md:text-xl font-extrabold mb-4">로그인</h1>
      ...
      <section className="py-10 animate-fadeIn max-w-md mx-auto px-4">
        <div className="shadow-lg rounded-lg bg-white dark:bg-gray-800 text-black dark:text-white p-6">
          ...
          <div className="space-y-3 mb-6">
            ...
            >
              <span className="font-semibold">Google</span> 계정으로 로그인
            </button>
            <button
              onClick={() => alert("Naver 로그인 예정")}
            ...
            >
              <span className="font-semibold">Naver</span> 계정으로 로그인
            </button>
            <button
              onClick={() => alert("Kakao 로그인 예정")}
            ...
            >
              <span className="font-semibold">Kakao</span> 계정으로 로그인
            </button>
          </div>
          ...
          <div className="flex items-center my-6">
            ...
            <span className="mx-4 text-xs text-gray-400">또는 이메일로 로그인</span>
            <hr className="flex-grow border-gray-300 dark:border-gray-600" />
          </div>
